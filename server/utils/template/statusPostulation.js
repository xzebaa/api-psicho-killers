const statusPostulationTemplate = ({ name }) => {
  return `
              ...
              <tr style="border-collapse:collapse">
                <td align="center" style="padding:0;Margin:0">
                  ...
                  >
                    ...
                    <tr style="border-collapse:collapse">
                      <td
                        style="Margin:0;padding-top:20px;padding-left:52px;padding-right:52px;background-color:#FFFFFF"
                        bgcolor="#ffcc99"
                        align="left"
                      >
                        <table
                                ...
                                <tr style="border-collapse:collapse">
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      postulación a Developer Semi - Senior.
                                    </p>
                                  </td>
                                </tr>
                              </table>
                    ...
                    <tr style="border-collapse:collapse">
                      <td
                        style="Margin:0;padding-bottom:20px;padding-left:52px;padding-right:52px;background-color:#FFFFFF"
                        bgcolor="#ffcc99"
                        align="left"
                      >
                        <table
                                ...
                                <tr style="border-collapse:collapse">
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      número: +56 9784 5148.<br /><br />

                                      Si tienes alguna preferencia horaria o
                                      prefieres que te llamemos a otro número,
                                      por favor enviamos un mail para
                                      comunicarnos contigo a la brevedad.<br /><br />
                                    </p>
                                    <p class="dudeEmail">
                                    ...
                                    >
                                      ...
                                      un mail a :<br /><br />
                                      marcela.aravena@peanuthub.cl<br /><br />

                                      Será un gusto poder conversar.<br /><br /><br /><br />
...
module.exports = { statusPostulationTemplate };
